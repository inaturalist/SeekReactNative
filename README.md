...
3. Add AR Camera model and taxonomy files.
    ...
    1. On iOS, these files are named `smallINatVision_Small_2_fact256_8bit.mlmodel`, `INatGeomodel_Small_2_8bit.mlmodel` and `taxonomy.json`, but need to be renamed to `optimized_model_v2_30.mlmodel`, `geomodel_v2_30.mlmodel` and `taxonomy_v2_30.json`, respectively, and should be added to the Resources folder in XCode.
...
1. You need to make a tag before next step following the previous pattern
